...
class PostAmenitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        PostAmenity::insert([
            ...
            [ 'post_id' => '1', 'amenity_id' => '5', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now() ],
            [ 'post_id' => '1', 'amenity_id' => '6', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now() ],
            ...
            [ 'post_id' => '2', 'amenity_id' => '6', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now() ],

            [ 'post_id' => '3', 'amenity_id' => '1', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now() ],
            [ 'post_id' => '3', 'amenity_id' => '2', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now() ],
            ...
            [ 'post_id' => '3', 'amenity_id' => '6', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now() ],
